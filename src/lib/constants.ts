...
export const playersURL = 'http://apifutebol.footstats.com.br/3.1/players/:id';
export const topScorersURL = 'http://apifutebol.footstats.com.br/3.1/championships/950/scorers';